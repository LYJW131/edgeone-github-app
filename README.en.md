...
Report Tencent Cloud EdgeOne Pages/Makers deployments back to GitHub as commit statuses and GitHub Deployments. Repository code, CI workflows, and EdgeOne build commands do not need to change.
...
- [Architecture and security model](docs/architecture.en.md) · [中文](docs/architecture.md)
- [Create your own GitHub App and deploy the Worker](docs/operator-setup.en.md) · [中文](docs/operator-setup.md)
